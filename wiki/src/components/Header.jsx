...
function Header({
  ...
  return <div className="flex items-center justify-between flex-wrap w-full bg-tkm_purple text-tkm_white p-3">
      <div className="flex items-center w-4/5">
        <a className="w-1/4 md:w-1/6 lg:w-1/12" href="/TwitchKillMe/en-us/getting-started/">
      ...
      <div className="lg:hidden w-full">
        <Menu lang={lang} currentPathMenu={currentPathMenu} active={!hideMenu} />
      </div>
    </div>;
}
