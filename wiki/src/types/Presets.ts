import { EntityType, ArmorSlots, MaterialType, DropSlots, Gamemodes, AlertType, PotionType, Ticks, Seconds } from "./SpigotTypes";
...
type RawPresets = SummonPreset | GivePreset | ArmorPreset | DropPresets | ConsoleCommandPreset | GamemodePreset | VoidChunkPreset | FreezePreset | TeleportPreset | PlacePreset | ClearInventoryPreset | RandomRewardPreset | MultiRewardPreset | PotionRainPreset;
